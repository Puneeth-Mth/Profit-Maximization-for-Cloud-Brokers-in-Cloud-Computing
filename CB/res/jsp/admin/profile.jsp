...
%>
			...
			<div align="right" style="position:absolute;top:40px;left:375px">
				<a class="button button5" href="<%=request.getContextPath() %>/EditProfile?username=<%=username %>&no=1">Edit Profile</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a class="button button5" href="<%=request.getContextPath() %>/ChangePass?username=<%=username %>&no=1&id=<%=id %>">Change Password</a>
			</div>
			<br>
...
<!-- Display Contents (Starts) -->
					...
					<div align="right" style="position:absolute;top:30px;left:375px">
						...
						<a class="button button5" href="<%=request.getContextPath() %>/ChangePass?username=<%=username %>&no=1&id=<%=id %>" target="myIframe">Change Password</a>
					</div>
					<br></br>
					<div id="a2" align="right" style="position:absolute;top:70px;left:25px">
